...
Check the documentation on how to use it with [javadocs](http://tcurdt.github.com/jdependency/release/2.1/apidocs/) and a source
[xref](http://tcurdt.github.com/jdependency/release/2.1/xref/) is also available.
