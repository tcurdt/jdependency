...
public final class DependencyUtilsTestCase {
    ...
    private static final class ClassWithStringConstant {
        private String getValue() {
            return "Lorg/vafer/jdependency/NotARealDependency;";
        }
    }
    ...
    @Test
    public void testShouldNotFindClassNamesInStringConstants() throws Exception {
        final Set<String> dependencies = DependencyUtils.getDependenciesOfClass(ClassWithStringConstant.class);
        assertTrue(dependencies.contains("java.lang.String"));
        assertFalse(dependencies.contains("org.vafer.jdependency.NotARealDependency"));
    }
